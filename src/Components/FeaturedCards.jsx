  ...
  return (
    <div className="">
      <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-[90%] mx-auto rounded-xl bg-clip-border">
        ...
        <div className="relative mx-4 mt-4 bg-cover overflow-hidden text-gray-700 bg-white shadow-2xl  rounded-xl bg-clip-border h-72">
          <img
        ...
        <div className="pt-6 pl-6 text-left flex gap-2">
          <div>
            <img
              className="w-8 h-8 rounded-full inline ml-4"
        ...
        <div className="p-6 space-y-4 font-roboto">
          ...
          <p> <span className="font-bold">Note:</span> {featuredFood.additionalNotes}</p>
